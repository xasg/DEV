...
<section id="main" class="column">
    ...
    <article class="module width_full">
		<header><h3 class="tabs_involved">BENEFICIARIOS EXPERIMENTA 2012</h3>
		<ul class="tabs">
...
FROM TEST.CANDIDATO WHERE ID_ALUMNO>1999 AND id_ALUMNO<2500;*/                        
$consulta = $db->consulta("
SELECT LPAD(ID_ALUMNO,4,0) AS 'FOLIO', ID_CVECURP AS 'CURP', 
NB_NOMAPATERNO AS 'APATERNO', NB_NOMAMATERNO AS 'AMATERNO',
NB_NOMNOMBRE1 AS 'NOMBRE1', NB_NOMNOMBRE2 AS 'NOMBRE2',
(SELECT ID_NMBNOMBRE FROM CAT_IES WHERE ID_IES=FK_ID_IES ) AS 'IES'
FROM TEST.001_CANDIDATO WHERE ID_ALUMNO>1999 AND ID_ALUMNO<2500 AND TP_STATUS=1;
");
?>                        
...
NB_NOMNOMBRE1 AS 'NOMBRE1', NB_NOMNOMBRE2 AS 'NOMBRE2',
(SELECT ID_NMBNOMBRE FROM CAT_IES WHERE ID_IES=FK_ID_IES ) AS 'IES'
FROM TEST.001_CANDIDATO WHERE ID_ALUMNO>1999 AND ID_ALUMNO<2500 AND TP_STATUS=0;
");
?>
